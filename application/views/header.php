...
<?php
  ...
  if(get_cookie('language')){
    require_once('translation/'.get_cookie('language').'.php') ;
    //include 'footer.php';
  }else{
    require_once('translation/English.php');
  }
?>
    ...
    <div class="navbar-right">
      <div class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a href="<?php echo site_url('LanguageController/changeLanguage/Sinhala'); ?>">Sinhala</a></li>
          <li><a href="<?php echo site_url('LanguageController/changeLanguage/Tamil'); ?>">Tamil</a></li>
          <li><a href="<?php echo site_url('LanguageController/changeLanguage/English'); ?>">English</a></li>
        </ul>
      </div>
    </div>
