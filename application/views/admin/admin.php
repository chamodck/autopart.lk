...
<body>
    ...
    <!-- /#wrapper -->
    <script src="<?php echo base_url();?>script/admin/raphael-min.js"></script>
    <script src="<?php echo base_url();?>script/admin/morris.min.js"></script>
    <script src="<?php echo base_url();?>script/admin/morris-data.js"></script>
